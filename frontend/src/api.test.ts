...
import { fetchCategories, fetchFolderStructure, fetchFolderStructureComparison } from './api'
import { mockFetchSuccess, mockFetchError, resetMocks, mockCategoriesResponse, mockFolderViewResponse } from './test/mocks'
